...
object. Many functions in bioconductor packages know how to deal directly with `SummarizedExperiments` so you don't ever have to take the trouble extracting 
...
[backings](https://bioconductor.org/packages/release/bioc/html/HDF5Array.html) for storing out of memory data, tidyverse [interfaces](https://stemangiola.github.io/tidySummarizedExperiment/) to `SummarizedExperiment` objects, and much more.
