...
#' @param fillBy metadata column used to group and fill boxplots. Default NULL, 
...
#'   theme_coriell()
#'   
#' # Plot the boxplot by Group in metadata
...
plot_boxplot <- function(x, metadata = NULL, fillBy = NULL, ...) {
  ...
  ggplot2::ggplot(dt.m, ggplot2::aes_string(x = fillBy, y = ".value")) +
