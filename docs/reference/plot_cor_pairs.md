...
visualized in each panel. Inspired by \`methylKit::getCorrelation(...,
plot=TRUE)\` and examples in \`pairs()\`
...
- cor_method:
  ...
  Method to use for calculating correlations. One of "pearson"
...
- scatter_colramp:
  ...
  used in the smoothScatter plots
